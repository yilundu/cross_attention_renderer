...
class DPT(BaseModel):
    ...
    def forward(self, x, rel_transform, nviews):
        ...
        # torch.Size([12, 256, 192, 192]) torch.Size([12, 256, 96, 96]) torch.Size([12, 256, 48, 48]) torch.Size([12, 256, 24, 24])
        # import pdb
        # pdb.set_trace()
        # print(path_1.size())
        # print(path_2.size())
...
class DPTDepthModel(DPT):
    ...
    def forward(self, x, y, nviews):
        return super().forward(x, y, nviews)
